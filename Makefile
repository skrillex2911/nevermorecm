...
ARCH		=arm
CROSS_COMPILE	=../hyper/bin/arm-linux-androideabi-
...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -fno-tree-vectorize -fomit-frame-pointer
