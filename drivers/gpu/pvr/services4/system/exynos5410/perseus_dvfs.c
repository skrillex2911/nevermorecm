...
/* level, clock, voltage, src clk, min, max, qmin, qmax, stay, mask, etc */
	{ 0,    640, 1050000,     640, 200, 240,   190, 250, 1, 0, 0 },
	{ 1,    600, 1025000,     600, 190, 240,   180, 250, 1, 0, 0 },
	{ 2,    532,  975000,     532, 180, 240,   170, 250, 1, 0, 0 },
	{ 3,    480,  937500,     480, 170, 200,   160, 250, 2, 0, 0 },
	{ 4,    350,  850000,     350, 160, 190,   150, 250, 3, 0, 0 },
	{ 5,    266,  850000,     266, 150, 200,   140, 250, 3, 0, 0 },
	{ 6,    177,  850000,     177,   0, 200,     0, 220, 3, 0, 0 },
};
