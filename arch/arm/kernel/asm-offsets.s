	...
	.file	"asm-offsets.c"
@ GNU C11 (Hyper-OOLCHAIN1-X-OOLCHAIN2-6.x) version 6.1.1 20160509 (arm-eabi)
@	compiled by GNU C version 4.8.5, GMP version 6.1.99, MPFR version 3.2.0-dev, MPC version 1.1dev, isl version 0.15
...
@ -Wstrict-prototypes -Wno-trigraphs -Wno-format-security -Wno-unused
@ -Wno-maybe-uninitialized -Wno-array-bounds -Wno-sizeof-pointer-memaccess
...
@ -mapcs-frame -marm -mlittle-endian -mpic-data-is-text-relative
...
@ 0 "" 2
	...
	ldmfd	sp, {fp, sp, pc}	@
	.size	main, .-main
	.ident	"GCC: (Hyper-OOLCHAIN1-X-OOLCHAIN2-6.x) 6.1.1 20160509"
