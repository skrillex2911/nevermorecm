cmd_scripts/mod/file2alias.o := gcc -Wp,-MD,scripts/mod/.file2alias.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fgraphite -fno-tree-vectorize -fomit-frame-pointer     -c -o scripts/mod/file2alias.o scripts/mod/file2alias.c
